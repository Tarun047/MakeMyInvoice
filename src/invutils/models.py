...
class ClientInfo(AddressInfo):
    ...
    """
    def __init__(self, name=None, street=None, city=None, state=None, country=None, post_code=None,
                 email=None, client_id=None,vat_tax_number=None):
        """
        :type name: str or unicode or None
        :type street: str or unicode or None
        :type city: str or unicode or None
...
class Item(object):
    ...
    """
    def __init__(self, name, description, units, unit_price,gst):
        """
        Item modal init
    ...
    @property
    def amount(self):
        return int(self.units) * Decimal(str(self.unit_price*(100+self.gst)/100))
